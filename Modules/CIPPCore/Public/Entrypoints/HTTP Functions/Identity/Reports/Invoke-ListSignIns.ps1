Function Invoke-ListSignIns {
    ...
    try {
        ...
        $select = 'id,createdDateTime,userDisplayName,userPrincipalName,userId,appDisplayName,appId,status,location,ipAddress,clientAppUsed,riskDetail,riskLevelAggregated,riskLevelDuringSignIn,riskState,riskEventTypes_v2,resourceDisplayName,conditionalAccessStatus,correlationId'
